...
export default function FilteredPlaces() {
  ...
  const places = location.state?.places || []; // Get the passed places data or an empty array
  
  return (
    <div className="mt-5 flex flex-col gap-8">
      <h1 className="p-2 text-3xl text-gray-900">Available places according to your filter</h1>
